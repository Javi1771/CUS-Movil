  ...
  static List<Secretaria> getSecretariasEjemplo() {
    return [
      Secretaria(
        ...
        descripcion: 'Organizar las actividades particulares de la persona titular de la Presidencia Municipal y sus relaciones particulares, coordinando la agenda particular con las actividades de la Administración Pública.',
        direccion: 'Av. Paso de los Guzmán, No. 24, Barrio de la Concepción',
        latitud: 20.3895,
        longitud: -99.9967,
        telefono: '(427) 689 0012 Ext. 201',
        ...
        imagen: 'https://via.placeholder.com/300x200/0B3B60/FFFFFF?text=Particular',
        servicios: ['Atención Ciudadana', 'Relaciones Públicas', 'Desarrollo Político', 'Comunicación Social'],
        color: '#0B3B60',
      ),
      Secretaria(
        id: '2',
        nombre: 'Secretaría de Gobierno',
        descripcion: 'Promover e instrumentar los mecanismos institucionales que garanticen la gobernabilidad, el estado de derecho y la paz social en el municipio.',
        direccion: 'Av. Paso de los Guzmán, No. 24, Barrio de la Concepción',
        latitud: 20.3895,
        longitud: -99.9967,
        telefono: '(427) 689 0012 Ext. 301',
        ...
        imagen: 'https://via.placeholder.com/300x200/2196F3/FFFFFF?text=Gobierno',
        servicios: ['Registro Civil', 'Protección Civil', 'Juzgados Cívicos', 'Capacitación Civil', 'Enlace Bomberos'],
        color: '#2196F3',
      ),
      Secretaria(
        id: '3',
        nombre: 'Secretaría de Administración',
        descripcion: 'Administrar los recursos humanos, materiales y técnicos, así como los servicios internos de la Administración Pública Municipal.',
        direccion: 'Av. Paso de los Guzmán, No. 24, Barrio de la Concepción',
        latitud: 20.3895,
        longitud: -99.9967,
        telefono: '(427) 689 0012 Ext. 401',
        ...
        direcciones: [
          ...
          DireccionDepartamento(
            ...
            objetivo: 'Planear, coordinar, analizar, evaluar y realizar las acciones necesarias para mantener la funcionalidad de las instalaciones eléctricas, evitar fallas y contribuir a la protección de sistemas, así como de los propios trabajadores.',
          ),
        ],
        imagen: 'https://via.placeholder.com/300x200/FF9800/FFFFFF?text=Administracion',
        servicios: ['Recursos Humanos', 'Adquisiciones', 'Informática', 'Infraestructura y Mantenimiento'],
        color: '#FF9800',
      ),
      Secretaria(
        id: '4',
        nombre: 'Secretaría de Seguridad Pública Municipal',
        descripcion: 'Preservar y garantizar el orden y la seguridad pública en el territorio municipal, con base en las leyes, reglamentos, planes y programas establecidos.',
        direccion: 'Calle Río Moctezuma No. 199, Col. Nuevo San Juan, San Juan del Río, Qro.',
        latitud: 20.3850,
        longitud: -99.9900,
        ...
        servicios: ['Seguridad Pública', 'Prevención del Delito', 'Coordinación de Seguridad', 'Administración'],
        color: '#F44336',
      ),
      Secretaria(
        id: '5',
        nombre: 'Secretaría de Obras Públicas y Desarrollo Urbano',
        descripcion: 'Formular, dirigir, ejecutar y evaluar los planes, programas, proyectos y obras públicas municipales, bajo principios de legalidad, eficiencia, transparencia y congruencia social.',
        direccion: 'Av. Paso de los Guzmán, No. 24, Barrio de la Concepción',
        latitud: 20.3895,
        longitud: -99.9967,
        telefono: '(427) 689 0012 Ext. 201',
        ...
        servicios: ['Estudios y Proyectos', 'Supervisión', 'Desarrollo Urbano', 'Medio Ambiente y Ecología'],
        color: '#795548',
      ),
      Secretaria(
        id: '6',
        nombre: 'Secretaría de Desarrollo Social',
        descripcion: 'Reducir la desigualdad social a través del combate a la pobreza, facilitar el acceso a bienes, servicios y oportunidades básicas para el mejoramiento de la calidad de vida.',
        direccion: 'Av. Benito Juárez Ote. 36, Centro, 76800 San Juan del Río, Qro.',
        latitud: 20.3888,
        longitud: -99.9956,
        telefono: '(427) 689 0012 Ext. 804',
        email: 'desarrollo@sanjuandelrio.gob.mx',
        horarioAtencion: 'Lunes a Viernes: 8:00 AM - 4:00 PM',
        secretario: 'Bibiana Rodríguez Montes',
        direcciones: [
          DireccionDepartamento(
            nombre: 'Dirección de Programas, Proyectos, Evaluación y Conclusión',
            objetivo: 'Promover la participación social democrática en la administración de programas y proyectos que coadyuven a elevar el nivel de vida de los sectores sociales más vulnerables del Municipio.',
          ),
          DireccionDepartamento(
            nombre: 'Dirección de Participación Ciudadana',
            objetivo: 'Impulsar y facilitar la Participación Ciudadana corresponsable e incluyente en el quehacer público del municipio, contribuyendo al fortalecimiento del tejido social en San Juan del Río.',
          ),
        ],
        imagen: 'https://via.placeholder.com/300x200/4CAF50/FFFFFF?text=Desarrollo',
        servicios: ['Programas Sociales', 'Participación Ciudadana', 'Proyectos de Evaluación', 'Combate a la Pobreza'],
        color: '#4CAF50',
      ),
      Secretaria(
        id: '7',
        nombre: 'Secretaría de la Mujer',
        descripcion: 'Dirigir, coordinar, gestionar y ejecutar políticas públicas, programas y acciones que garanticen los derechos humanos de las mujeres.',
        ...
        servicios: ['Igualdad de Género', 'Prevención de Violencia', 'Programación y Calidad', 'Atención Especializada'],
        color: '#E91E63',
      ),
      Secretaria(
        id: '8',
        nombre: 'Secretaría del Ayuntamiento',
        descripcion: 'Contribuir a la eficaz organización y desarrollo de las Sesiones de Cabildo, así como de las Comisiones Permanentes de Dictamen.',
        direccion: 'Av. Paso de los Guzmán, No. 24, Barrio de la Concepción',
        latitud: 20.3895,
        longitud: -99.9967,
        telefono: '(427) 689 0012 Ext. 201',
        ...
        direcciones: [
          DireccionDepartamento(
            ...
            objetivo: 'Contribuir a la eficaz organización y desarrollo de las Sesiones de Cabildo, así como de las Comisiones Permanentes de Dictamen.',
          ),
          DireccionDepartamento(
        ...
        imagen: 'https://via.placeholder.com/300x200/607D8B/FFFFFF?text=Ayuntamiento',
        servicios: ['Asuntos de Cabildo', 'Proyectos', 'Dirección Jurídica', 'Sesiones de Cabildo'],
        color: '#607D8B',
      ),
      Secretaria(
        id: '9',
        nombre: 'Secretaría de Finanzas',
        descripcion: 'Recaudar los ingresos y administrar los egresos municipales, con base en las disposiciones y normas jurídicas, reglamentarias y administrativas aplicables.',
        direccion: 'Av. Paso de los Guzmán, No. 24, Barrio de la Concepción',
        latitud: 20.3895,
        longitud: -99.9967,
        telefono: '(427) 689 0012 Ext. 1001',
        ...
        imagen: 'https://via.placeholder.com/300x200/009688/FFFFFF?text=Finanzas',
        servicios: ['Ingresos', 'Egresos', 'Administración Financiera', 'Recaudación'],
        color: '#009688',
      ),
      Secretaria(
        id: '10',
        nombre: 'Secretaría de Desarrollo Integral y Económico',
        descripcion: 'Programar, gestionar, coordinar y ejecutar los programas institucionales para el desarrollo sustentable, económico, empresarial y de fomento integral.',
        direccion: 'Av. Benito Juárez Ote. 36, Centro, 76800 San Juan del Río, Qro.',
        latitud: 20.3888,
        longitud: -99.9956,
        ...
        direcciones: [
          DireccionDepartamento(
            ...
            ubicacion: 'Acuática Gómez Morin, Alfonso Pasiño s/n, Centro, 76807 San Juan del Río, Qro.',
          ),
          DireccionDepartamento(
            nombre: 'Dirección de la Juventud',
            objetivo: 'Procurar el desarrollo integral de la juventud con equidad de oportunidades.',
            ubicacion: 'Ciudad Vive Oriente, Av. de las Garzas 57, Indeco, San Juan del Río, Qro.',
          ),
          DireccionDepartamento(
            ...
            ubicacion: 'Portal de Diezmo, Av. Benito Juárez No.15 Ote., San Juan del Río, Qro.',
          ),
          DireccionDepartamento(
            nombre: 'Dirección de Desarrollo Empresarial',
            objetivo: 'Apoyar el crecimiento empresarial del municipio.',
            ubicacion: 'Carretera Panamericana a Querétaro No.232, La Venta, Plaza Punta Victoria, San Juan del Río, Qro.',
          ),
          DireccionDepartamento(
        ...
        imagen: 'https://via.placeholder.com/300x200/9C27B0/FFFFFF?text=Economico',
        servicios: ['Deporte', 'Juventud', 'Bellas Artes', 'Desarrollo Empresarial', 'Turismo', 'MIPYMES'],
        color: '#9C27B0',
      ),
      Secretaria(
        id: '11',
        nombre: 'Secretaría de Desarrollo Agropecuario',
        descripcion: 'Organizar, promover, coordinar, gestionar programas, proyectos y actividades tendientes a un mejor aprovechamiento de los recursos naturales del Municipio.',
        ...
        direcciones: [
          DireccionDepartamento(
            ...
            objetivo: 'Promover, formular, gestionar, dirigir y ejecutar proyectos y programas que favorezcan el bienestar social y económico de los productores agropecuarios del municipio mediante el manejo sostenible y regenerativo de recursos naturales.',
            servicios: [
        ...
        imagen: 'https://via.placeholder.com/300x200/8BC34A/FFFFFF?text=Agropecuario',
        servicios: ['Desarrollo Agropecuario', 'Agronegocios', 'Infraestructura Rural', 'Integración Regenerativa'],
        color: '#8BC34A',
      ),
      Secretaria(
        id: '12',
        nombre: 'Secretaría de Órgano Interno de Control',
        descripcion: 'Vigilar que los servidores públicos del Municipio se desempeñen bajo los principios de legalidad, honestidad, imparcialidad, responsabilidad, eficiencia y eficacia.',
        direccion: 'Av. Benito Juárez Ote. 36, Centro, 76800 San Juan del Río, Qro.',
        latitud: 20.3888,
        longitud: -99.9956,
        ...
        imagen: 'https://via.placeholder.com/300x200/FF5722/FFFFFF?text=Control',
        servicios: ['Prevención y Atención', 'Investigación y Control', 'Substanciación', 'Auditorías'],
        color: '#FF5722',
      ),
      Secretaria(
        id: '13',
        nombre: 'Secretaría de Servicios Públicos Municipales',
        descripcion: 'Planear y proporcionar de manera oportuna y con calidad, los servicios públicos que presta el Gobierno Municipal a la sociedad.',
        direccion: 'Av. Benito Juárez Ote. 36, Centro, 76800 San Juan del Río, Qro.',
        latitud: 20.3888,
        longitud: -99.9956,
        telefono: '(427) 689 0012 Ext. 804',
        ...
        direcciones: [
          DireccionDepartamento(
            ...
            objetivo: 'Programar y coordinar la prestación de los servicios públicos, apegándose a las disposiciones legales, reglamentarias, técnicas y administrativas aplicables.',
          ),
          DireccionDepartamento(
          ...
          DireccionDepartamento(
            ...
            objetivo: 'Planear y proporcionar la conservación urbana del Municipio de San Juan del Río.',
          ),
        ],
        imagen: 'https://via.placeholder.com/300x200/3F51B5/FFFFFF?text=Servicios',
        servicios: ['Limpieza y Recolección', 'Control Animal', 'Infraestructura y Mantenimiento', 'Conservación Urbana'],
        color: '#3F51B5',
      ),
      Secretaria(
        id: '14',
        nombre: 'Secretaría de Centro de Atención Municipal',
        descripcion: 'Atender y dar un mejor servicio a la ciudadanía de manera óptima, eficaz, eficiente y transparente, con la finalidad de generar un beneficio integral.',
        direccion: 'Av. Benito Juárez Ote. 36, Centro, 76800 San Juan del Río, Qro.',
        latitud: 20.3888,
        longitud: -99.9956,
        ...
        direcciones: [
          DireccionDepartamento(
            ...
            objetivo: 'Acercar y otorgar servicio médico de primer nivel, y entregar medicamentos en la medida del presupuesto asignado, para beneficio de los sanjuanenses.',
          ),
          DireccionDepartamento(
            nombre: 'Dirección de Trámites Administrativos',
            objetivo: 'Acercar los trámites que realiza la administración pública, a la población para simplificar su acceso a los mismos y colaborar para la instalación de cobros de derechos, contribuciones, impuestos o cualquier otro que sea objeto de la administración pública.',
          ),
        ],
        imagen: 'https://via.placeholder.com/300x200/00BCD4/FFFFFF?text=Atencion',
        servicios: ['Salud Comunitaria', 'Trámites Administrativos', 'Atención Ciudadana', 'Servicios Integrales'],
        color: '#00BCD4',
      ),
    ];
  }
